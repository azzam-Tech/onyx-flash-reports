...
def test_fix_statement():
    ...
    # Simulating smart add_total_row
    totals = [0.0] * len(cols)
    for r in rows[1:]: # Skip opening balance row in movement totals sum
    ...
    print("=== SMART TOTAL ROW FOR CUSTOMER STATEMENT ===")
    print("Cols:", cols)
