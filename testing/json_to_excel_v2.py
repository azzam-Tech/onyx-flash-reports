    ...
    try:
        ...
        query = """
            SELECT c.C_CODE, c.C_A_NAME, c.C_TAX_CODE, 
                   ...
                   c.BUILDING_NO, c.STREET, c.DSTRCT_NM, c.EXTERNAL_POST, c.ADD_NO, c.CITY_NO, 
        ...
        csv_path = r'c:\Users\amarn\OneDrive\Desktop\dbOnyxOnAntigravity\Active_Fake_Customers_V2.csv'
