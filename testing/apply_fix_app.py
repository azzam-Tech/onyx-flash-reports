...
old_func_start = "def run_debt_movement_summary(rpt, args):"
old_func_end = "def run_report(rpt, args):"

idx1 = content.find(old_func_start)
idx2 = content.find(old_func_end, idx1)

if idx1 != -1 and idx2 != -1:
    new_func = '''def run_debt_movement_summary(rpt, args):
    ...
    with get_conn() as con:
        with con.cursor() as cur:
            ...
            for c_code, c_name, open_b, ns, col in cur.fetchall():
...
'''
    content = content[:idx1] + new_func + content[idx2:]
    with open(r"privet\onyx_reports\app.py", "w", encoding="utf-8") as f:
        f.write(content)
    print("App.py updated with ex-VAT sales column before Target!")
else:
    print("Function bounds not found")
