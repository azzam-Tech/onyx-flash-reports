...
def export_ac_no_movement():
    ...
    out_path = os.path.join(os.path.dirname(__file__), '..', 'Results', 'مكيفات_بدون_حركة.xlsx')
    wb.save(out_path)
    print(f"Exported {len(no_movement_items)} AC items to {out_path}")

if __name__ == '__main__':
    export_ac_no_movement()
