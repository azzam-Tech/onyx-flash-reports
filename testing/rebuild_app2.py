...
dst = r"C:\Users\amarn\OneDrive\Desktop\dbOnyxOnAntigravity\testing\app_rebuild2.py"
...
# We must use exactly the date order! 
# Let's get the scripts and sort them by modified time!
import glob
all_scripts = []
for s in scripts:
...
for script_path in all_scripts:
    ...
    # some scripts might use current directory
...
print(f"Done. Rebuilt app2 size: {os.path.getsize(dst)}")
