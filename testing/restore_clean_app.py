...
# Find line with acc_balance end: ORDER BY d.acc_code\n       """},
idx_start = -1
for i, l in enumerate(lines):
    if 'ORDER BY d.acc_code' in l:
        idx_start = i + 2 # line after """},
...
print(f"Found acc_balance end at line {idx_start}, stock start at line {idx_end}")

prof_code = '''   {"id":"prof","title":"الربحية","icon":"M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z","reports":[
...
new_lines = lines[:idx_start] + [prof_code + ",\n"] + lines[idx_end:]

with open(app_path, "w", encoding="utf-8") as f:
    f.writelines(new_lines)

print("RESTORED AND CLEANED APP.PY PROF TAB SUCCESSFULLY!")
